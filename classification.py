...
# ==========================================
print("=== KNN error vs K (1 to 15) and auto-select best K ===")
...
plt.title("KNN: Training vs Testing Error Rate (German Credit)")
plt.xlabel("K")
...
# ==========================================
print("\n=== Classifier comparison using best K for KNN ===")
